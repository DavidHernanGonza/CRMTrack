...
include 'liga_BD.php';
    ...
    if(isset($_POST['id_pro'])){
        ...
        $sql="UPDATE dato_gen SET id='".$_POST['id_pro']."', nombre='".$_POST['usuario']."',
        ...
        productos='".$pro."', status_cliente='".$st_cliente."', dato_gene='".$dato_gen."', hora_seguimeinto='".$_POST['hora_seguimiento']."', hora_tarea='".$_POST['hora_tarea']."'
        WHERE id='".$_POST['id_pro']."'";
        mysqli_query($link,$sql);
        ...
        VALUES ('".$_POST['correo']."','".$pro."','".$_POST['seguimiento']."','".$_POST['fecha_seguimiento']."','".$_POST['tarea']."','".$_POST['fecha_tarea']."','".$_POST['comentario']."','".$_POST['estatus']."','".$_POST['hora_tarea']."','".$_POST['hora_seguimiento']."')";
