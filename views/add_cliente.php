...
<body>
            ...
            <div><h4><small class="text-muted ml-5">Datos Cliente</small></h4></div>
            ...
            <div class="row mt-2 p-2 ">
             ...
             <div class="col text-center"><span id="fechaIxT" style="color: red;"></span>Lada: 
                   ...
                   <?php foreach($lad1 as $rowlad1){?>
                    <option data-img-src="../content/img/<?php echo $rowlad1['imagen']; ?>" value="<?php echo $rowlad1['id']; ?>"> <?php echo $rowlad1['id']; ?></option>
                    <?php } ?>
                   ...
                   <option data-img-src="img/brian.png">Brain Cugelman</option>-->
                    ...
                    <option data-img-src="../content/img/<?php echo $rowlad2['imagen']; ?>" value="<?php echo $rowlad2['id']; ?>"> <?php echo $rowlad2['id']; ?></option>
                    <?php } ?>
                    </select>
                    ...
                    <option data-img-src="../content/img/<?php echo $rowlad3['imagen'];?>" value="<?php echo $rowlad3['id']; ?>"> <?php echo $rowlad3['id']; ?></option>
                    <?php } ?>
                     </select>
            ...
            <div class="col-sm-4 mb-2">
                  <div class="card">
                    <div class="card-body">
                        <div class=" roundedv float-left m-2 text-center"><i class="fa fa-building fa-2x m-2" style="color:#18B8D1;"></i></div>
                     
                        <div class="m-3">
                            <div style="width: 300px; float: left;" id="usuario">
                            <span id="fechaIxT" style="color: red;">
                            <input class="form-control mr-sm-2 " type="text" placeholder="Empresa"   id="empresa"  style="border-color:#85C1E9;">
                             </div>
                        </div>                     
                    </div>
                  </div>
                ...
                <div class="col-sm-4 mb-2">
                  <div class="card">
                    <div class="card-body">
                        <div class=" roundedv float-left m-2 text-center"><i class="fa fa-briefcase fa-2x m-2" style="color:#18B8D1;"></i></div>
                     
                        <div class="m-3">
                            <div style="width: 300px; float: left;" id="usuario">
                            <input class="form-control mr-sm-2 " type="text" placeholder="Departamento"   id="departamento"  style="border-color:#85C1E9;">
                             </div>
                        </div>                     
                    </div>
                  </div>
                ...
                <div class="col-sm-4 mb-2">
                  <div class="card">
                    <div class="card-body">
                        <div class=" roundedv float-left m-2 text-center"><i class="fa fa-users fa-2x m-2" style="color:#18B8D1;"></i></div>
                        
                        <div class="m-2">
                            <div style="width: 300px; float: left;" id="telefono">
                            <input class="form-control mr-sm-2 " type="text" placeholder="Agrupamiento"   id="agrupacion"  style="border-color:#85C1E9;">
                             </div>
                        </div>                     
                    </div>
                  </div>
            ...
            <div class="row mt-2 p-2 border-bottom border-info">
                        ...
                        <div class=" roundedv float-left m-1 text-center"><i class="fa fa-facebook fa-2x m-2" style="color:#18B8D1;"></i></div>
                        ...
                        <div class=" roundedv float-left m-1 text-center"><i class="fa fa-youtube-play fa-2x m-2" style="color:#18B8D1;"></i></div>
                        ...
                        <div class=" roundedv float-left m-1 text-center"><i class="fa fa-twitter fa-2x m-2" style="color:#18B8D1;"></i></div>
                        ...
                        <div class=" roundedv float-left m-1 text-center"><i class="fa fa-linkedin fa-2x m-2" style="color:#18B8D1;"></i></div>
                        ...
                        <div class=" roundedv float-left m-1 text-center"><i class="fa fa-instagram fa-2x m-2" style="color:#18B8D1;"></i></div>
                        
                        <div class="m-1">
                            <div style="width: 200px; float: left;" id="telefono">
                            <input class="form-control mr-sm-1 " type="text" placeholder=""   id="insta"  style="border-color:#85C1E9;">
                             </div>
                        </div>  
            ...
            <div class="row mt-3 p-2">
                    ...
                    <button style="float: right;margin-left: 1em;"  type="button"  class="btn btn-danger btn-lg ml-3" value="modificarOrden" id="modificarOrden"><span class="fa fa-ban" ></span> Cancelar</button>
                    <button style="float: right;"  type="button"  class="btn btn-success btn-lg" value="agregarcliente" id="agregarcliente"><span class="fas fa-check-circle" ></span> Guardar </button>
