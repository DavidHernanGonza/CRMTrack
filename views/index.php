        ...
        <nav class="navbar border-bottom border-info">
          ...
          <div>
            <div class="row">
                ...
                <div class="col mt-3">
                    <div>
                        <form class="form-inline my-2 my-lg-0" style="float: left;"  action="add_cliente.php" method="POST" autocomplete="off">
                        ...
                        <!--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalU" data-whatever="@mdo">Agregar</button>-->
                          ...
                          <div class="text-center float-left" style="width:140px;">
                            <a href="#" data-toggle="modal" data-target="#instructivoModal"><i class="fas fa-book  fa-2x" aria-hidden="true"></i> <br>
                            <span style="font-size: 12px;">Cargar Archivo</span> </a>                                       
                        </div> 
                        <div class="text-center float-left" style="width:140px;">
                            <a href="#" data-toggle="modal" data-target="#cargarcontacto"><i class="fas fa-users  fa-2x" aria-hidden="true"></i> <br>
                        ...
                        foreach ($datos_clientes as $cols) { 
						 ...
						 <tr class="text-center">
                           ...
                           <td>
                            ...
                            <td><?php echo $cols['hora_seguimeinto']?></td>
                            <td>
                           ...
                           <a href="edita_prospecto.php?id=<?php echo $cols['id']?>" title="Editar datos" ><i class="fas fa-pencil-alt fa-2x text-warning"></i></a>
                          </div>
                          <div  class="col-sm-4 text-center float-left" style="width:60px; ">
                          <a  class="link_delete text-center" onclick="elimProspecto('<?php echo  $cols['id'];?>');" ><i class="fas fa-trash-alt  fa-2x text-danger"></i></a>
                          
                          </div>
                          <div  class="col-sm-4 text-center float-left" style="width:60px; ">
                           <a href="historial_prospecto.php?correo=<?php echo $cols['correo']?>" title="Historial" ><i class="fas fa-history fa-2x text-primary"></i></a>
                           </div>
...
<div class="modal fade" id="instructivoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- Modal ADD Instructivo -->
     ...
     <!-- Modal ADD Instructivo -->
<div class="modal fade" id="cargarcontacto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <form action="../controllers/subirContacto.php" enctype="multipart/form-data" id="form_fileUpcontacto" method="POST">
            <input type="hidden" name="subirInstructivo">
            <input class="form-control form-control-sm" type="file" name="file" id="file" onchange="validaArchivo('file', 'cargarcontacto', 'xlsx');">
            <div class="w-100 text-right">
              <button type="submit" id="submitFileInstr1" class="btn btn-primary mt-2 mb-2 mr-2 text-center">Cargar</button>
            </div>
