...
<nav class="navbar border-bottom border-info mt-3 ">
		    ...
		    Cliente: <?php echo $data ['nom_cliente']." ".$data ['apellido'];?>
                ...
                <a href="clientes.php" class="btn btn-warning mr-4"> <i class="fas fa-undo-alt"></i> Regresar</a> 
                
                    <h3><small class="text-muted">Producto:</small></h3> <p class="h4 color_azul m-2"> <?php echo $data ['nombre'];?> </p>
            ...
            <input type="hidden" id="nombre" name="nombre" value="<?php echo $data ['nombre'];?>">
            ...
            <div class="row mt-5 p-2  border-info">
                <div class="col-sm-5 mb-2">
                  <div class="card">
                    <div class="card-body">
                        <div class=" roundedv float-left m-1 text-center"><i class="fas fa-user fa-2x m-2" style="color:#18B8D1;"></i></div>
                     
                        <div class="m-3">
                            <div style="width: 200px; float: left;" id="usuario1">
                            <input class="form-control mr-sm-2 " type="search" placeholder="" aria-label="Buscar"  id="usuario" value="<?php echo $data ['nom_cliente'];?>" style="border-color:#85C1E9;">
                            
                             </div>
                             <div style="width: 200px; float: left;" id="usuario2">
                             
                            <input class="form-control ml-sm-2 " type="search" placeholder="" aria-label="Buscar"  id="apellido" value="<?php echo $data ['apellido'];?>" style="border-color:#85C1E9;">
                ...
                <div class="col-sm-3 mb-2">
                  <div class="card">
                    <div class="card-body">
                        <div class=" roundedv float-left m-1 text-center"><i class="fa fa-phone fa-2x m-2" style="color:#18B8D1;"></i></div>
                        
                        <div class="m-2">
                            <div style="width: 180px; float: left;" id="telefono1">
                            <input class="form-control mr-sm-2 " type="text" placeholder="" aria-label="Buscar" name="telefono" id="telefono" value="<?php echo $data ['celular'];?>" style="border-color:#85C1E9;">
                             </div>
                        </div>                     
                    </div>
                  </div>
                ...
                <div class="col-sm-4 mb-2">
                  <div class="card">
                    <div class="card-body">
                        <div class=" roundedv float-left m-1 text-center"><i class="fa fa-envelope fa-2x m-2" style="color:#18B8D1;"></i></div>
                      
                        <div class="m-2">
                            <div style="width: 300px; float: left;" id="correo2">
                            <input class="form-control mr-sm-2 " type="text" placeholder="" aria-label="Buscar" name="correo"  id="correo" value="<?php echo $data ['correo'];?>" style="border-color:#85C1E9;" disabled>
                             </div>
                        </div>                     
                    </div>
                  </div>
                ...
                <div class="col-md-3 text-center">
                   <span id="fechaIxT" style="color: red;"></span>Seguimiento: 
                        ...
                        foreach($segui as $rowseg){
                            if($rowseg['nom_seguimiento'] == $rowseg['seguimiento']){
                        ?>
                                <option value="<?php echo $rowseg['nom_seguimiento']; ?>" selected><?php echo $rowseg['seguimiento']; ?></option>
                        <?php 
                        }else{
                        ?>
                ...
                <div class="row mt-3 p-2">
                    ...
                    <span id="fechaIxT" style="color: red;"></span>Status: 
                        ...
                        ?>
                             ...
                             <div class="col text-center" style="width: 300px; " id="fuente_contacto2."><span id="fechaIxT" style="color: red;"></span>Fuente Contacto:
                            <input class="form-control mr-sm-3 " type="text" placeholder="" aria-label="Buscar" name="fuente_contacto" id="fuente_contacto" value="<?php echo $data ['fuente_contacto']?>" style="border-color:#85C1E9;">
                             ...
                             <div class="col text-center" style="width: 300px; " id="estatus_cliente2."><span id="fechaIxT" style="color: red;"></span>Estatus Cliente:
                            <input class="form-control mr-sm-3 " type="text" placeholder="" aria-label="Buscar" name="estatus_cliente" id="estatus_cliente" value="<?php echo $data ['status_cliente']?>" style="border-color:#85C1E9;" disabled>
                             ...
                             <div class="col text-center" style="width: 300px;" id="dato_gen2."><span id="fechaIxT" style="color: red;"></span>Dato General:
                ...
                <div class="row mt-3 p-2">
                    ...
                    <button style="float: left; "  type="button"  class="btn btn-success btn-lg ml-r" value="modificarcliente" id="modificarcliente"><span class="fas fa-check-circle" ></span> Actualizar</button>
